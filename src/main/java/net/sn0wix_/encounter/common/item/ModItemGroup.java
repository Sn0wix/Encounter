...
public class ModItemGroup {
    public static final ItemGroup NORMAL_ITEM_GROUP = Registry.register(Registries.ITEM_GROUP, new Identifier(Encounter.MOD_ID,"item_tab"), FabricItemGroup.builder().displayName(Text.translatable(Encounter.MOD_ID + ".item_tab")).icon(() -> new ItemStack(Items.WITHER_SKELETON_SKULL)).build());
