...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        Item item1 = Registry.register(Registries.ITEM, new Identifier(Incounter.MOD_ID, name), item);
    ...
    public static void registerModItems() {
        Incounter.LOGGER.info("Registering Mod items for " + Incounter.MOD_ID);
    }
}
